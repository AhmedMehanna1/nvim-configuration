return {
    ...
    },
    {
        ...
        config = function()
            ...
            -- Set a vim motion to <Space> + g + <Shift>R to restore files changed to the staging area
            vim.keymap.set("n", "<leader>gR", ":Git restore .<cr>", { desc = "[G]it Restore [A]ll" })
            -- Set a vim motion to <Space> + g + r to restore the current file and changes to the staging area
            vim.keymap.set("n", "<leader>gr", "Git restore", { desc = "[G]it [R]estore" })
